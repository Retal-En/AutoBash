...
class PurchaseRequisition(models.Model):
    ...
    purchase_type = fields.Selection(
        [('external_service', 'External Service'), ('external_purchase', 'External Purchase')], 'Purchase Type')
    ...
    def button_requisition_approved(self):
        line_ids = []
        for line in self.requisition_line_ids:
            line_ids.append((0, 0, {
